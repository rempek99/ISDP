...
public class PasswordChangeTest {
    ...
    private String userPassword, newPassword;
    ...
    public void notSingedInPassChangeTest() {
        ...
        driver.findElement(By.id("ResetPasswordForm:login")).sendKeys(userName);
        ...
        driver.findElement(By.id("ResetPasswordForm:newPassword")).sendKeys(userPassword);
        driver.findElement(By.id("ResetPasswordForm:newPasswordRepeat")).sendKeys(userPassword);
